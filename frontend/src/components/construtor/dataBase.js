...
export default {
  ...
  colorWall: [
    ...
    { background: "rgb(233, 234, 222)", title: "F450" },
    { background: "rgb(232, 228, 223)", title: "Y481" },
    { background: "rgb(225, 219, 220)", title: "Y426" },
    { background: "rgb(216, 221, 226)", title: "F490" },
    { background: "rgb(220, 221, 219)", title: "G499" },
    { background: "rgb(226, 218, 213)", title: "F483" },
    { background: "rgb(248, 235, 193)", title: "G304" },
    { background: "rgb(219, 223, 225)", title: "G500" },
    { background: "rgb(233, 222, 215)", title: "F474" },
    { background: "rgb(229, 221, 212", title: "G484" },
    { background: "rgb(217, 214, 206)", title: "G487" },
    { background: "rgb(208, 210, 204)", title: "H495" },
    { background: "rgb(203, 213, 217)", title: "Y396" },
    { background: "rgb(207, 207, 210)", title: "G488" },
    { background: "rgb(198, 203, 211)", title: "G489" },
    { background: "rgb(195, 202, 206)", title: "J500" },
    { background: "rgb(231, 210, 188)", title: "H470" },
    { background: "rgb(207, 211, 198)", title: "G444" },
    { background: "rgb(219, 208, 208)", title: "H501" },
    { background: "rgb(217, 206, 194)", title: "H485" },
    { background: "rgb(185, 188, 187)", title: "K496" },
    { background: "rgb(182, 194, 196)", title: "X438" },
    { background: "rgb(202, 196, 187)", title: "H486" },
    { background: "rgb(185, 191, 196)", title: "K498" },
    { background: "rgb(228, 210, 167)", title: "H456" },
    { background: "rgb(179, 187, 193)", title: "K500" },
    { background: "rgb(171, 181, 166)", title: "L494" },
    { background: "rgb(168, 172, 183)", title: "K489" },
    { background: "rgb(185, 181, 173)", title: "V487" },
    { background: "rgb(191, 180, 165)", title: "V484" },
    { background: "rgb(183, 171, 169)", title: "V481" },
    { background: "rgb(165, 179, 194)", title: "J490" },
    { background: "rgb(152, 167, 173)", title: "V438" },
    { background: "rgb(181, 164, 145)", title: "K484" },
    { background: "rgb(167, 167, 161)", title: "M497" },
    { background: "rgb(217, 206, 194)", title: "K488" },
    { background: "rgb(146, 155, 147)", title: "V444" },
    { background: "rgb(137, 157, 163)", title: "L491" },
    { background: "rgb(154, 144, 132)", title: "S486" },
    { background: "rgb(137, 146, 154)", title: "N500" },
    { background: "rgb(137, 138, 136)", title: "L499" },
    { background: "rgb(129, 144, 158)", title: "M490" },
    { background: "rgb(117, 137, 155)", title: "S435" },
    { background: "rgb(113, 135, 143)", title: "S438" },
    { background: "rgb(131, 134, 107)", title: "L447" },
    { background: "rgb(129, 138, 129)", title: "N494" },
    { background: "rgb(151, 133, 121)", title: "V467" },
    { background: "rgb(116, 123, 131)", title: "S500" },
    { background: "rgb(97, 118, 142)", title: "S431" },
    { background: "rgb(68, 114, 108)", title: "N370" },
    { background: "rgb(93, 106, 118)", title: "V490" },
    { background: "rgb(110, 98, 87)", title: "N485" },
    { background: "rgb(67, 88, 118)", title: "N434" },
    { background: "rgb(115, 74, 68)", title: "M476" },
    { background: "rgb(80, 83, 86)", title: "Y500" },
    { background: "rgb(95, 100, 115)", title: "M428" },
    { background: "rgb(71, 84, 79)", title: "N442" }
  ],
  srcSample: [
    {
      sampleImage: image5,
